...
class $export RelationService : public ::javax::management::NotificationBroadcasterSupport, public ::javax::management::relation::RelationServiceMBean, public ::javax::management::MBeanRegistration, public ::javax::management::NotificationListener {
