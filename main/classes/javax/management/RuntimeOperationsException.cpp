...
RuntimeOperationsException::RuntimeOperationsException(const RuntimeOperationsException& e) {
}

RuntimeOperationsException RuntimeOperationsException::wrapper$() {
	$pendingException(this);
	return *this;
}

void RuntimeOperationsException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
