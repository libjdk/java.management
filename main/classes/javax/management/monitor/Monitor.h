...
class $export Monitor : public ::javax::management::NotificationBroadcasterSupport, public ::javax::management::monitor::MonitorMBean, public ::javax::management::MBeanRegistration {
