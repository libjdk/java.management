...
class $import MLet : public ::java::net::URLClassLoader, public ::javax::management::loading::MLetMBean, public ::javax::management::MBeanRegistration, public ::java::io::Externalizable {
