...
class $import RequiredModelMBean : public ::javax::management::modelmbean::ModelMBean, public ::javax::management::MBeanRegistration, public ::javax::management::NotificationEmitter {
