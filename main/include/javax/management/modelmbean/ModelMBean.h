...
class $import ModelMBean : public ::javax::management::DynamicMBean, public ::javax::management::PersistentMBean, public ::javax::management::modelmbean::ModelMBeanNotificationBroadcaster {
