...
class $import TabularDataSupport : public ::javax::management::openmbean::TabularData, public ::java::util::Map, public ::java::lang::Cloneable, public ::java::io::Serializable {
