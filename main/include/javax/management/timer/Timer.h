...
class $import Timer : public ::javax::management::NotificationBroadcasterSupport, public ::javax::management::timer::TimerMBean, public ::javax::management::MBeanRegistration {
